...
public class MsgAndCode {
    ...
    public final static String FAILE_CODE = "999";
    public final static String FAILE_MESSAGE = "失败";
    ...
    public final static String NULL_CODE = "998";
    public final static String NULL_MESSAGE = "上传参数为空！";

    public final static String EXCEPTION_CODE = "997";
    public final static String EXCEPTION_MESSAGE = "系统异常！";

    public final static String NOAUTH_CODE = "996";
    public final static String NOAUTH_MESSAGE = "权限不足，无法访问接口！";
